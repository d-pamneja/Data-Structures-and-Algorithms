...
CLASS HOMEWORK: 20
	1. Print the Fibonacci series using an iterative method [DP]
...
CLASS NOTES: 21
	...
	5. Coin change (Leetcode-322) [DP]
	6. House Robber (Leetcode-198) [DP]
...
CLASS HOMEWORK: 31
	...
	16. Quic Sort on Linked List (GFG)
	17. Remove Duplicates from an Unsorted Linked List (GFG)
...
HOMEWORK NOTES: 37
	...
	16. First Non-Repeating Character in a Stream (GFG)
...
<details>
  <summary>WEEK 16 TOPIC: Hashmaps & Tries - Class 04</summary>
...
HOMEWORK NOTES: 50
	...
	11. Palindrome Pairs
	12. Check if all levels of two trees are anagrams or not.
	13. Find shortest unique prefix for every word in a given list
	14. Word Break Problem | (Trie solution)
	15. Given a sequence of words, print all anagrams together
	16. Implement a Phone Directory
	17. Print unique rows in a given boolean matrix
...
```bash
CLASS ASSIGNMENTS : 63
	1. Eventual Safe States (Leetcode-802)
	2. Minimum Multiplication to reach End - (GFG)
	3. Find the City With the Smallest Number of Neighbors at a Threshold Distance - (Leetcode 1334)
	4. Prim’s Algorithm for MST (GFG)
	5. Kruskals Algorithm for MST (GFG)
	6. Accounts Merge (Leetcode-721)
	7. Number of operations to make network connected - (Leetcode 1319)
	8. Word Ladder-1 (Leetcode-127)
	9. Word Ladder-2 (GFG)
...
<details>
  <summary>WEEK 21 TOPIC: Greedy Technique</summary>

```bash
CLASS ASSIGNMENTS : 64
	1. DEFKIN - Defense of a Kingdom - (SPOJ)
	2. Minimum Cost of Ropes - (GFG)
	3. Huffman Coding Algorithm
	4. Fractional Knapsack Problem - (GFG)
	5. Number of meetings in one room - (GFG)
	6. Minimum train platforms required for a railway station - (GFG)
	7. Chocolate Distribution Problem - (GFG)
	8. Chocolate Distribution Problem II - (GFG)
...
<details>
  <summary>WEEK 21 TOPIC: Sliding Window Technique - Assignments</summary>
...
CLASS ASSIGNMENTS : 66
	...
	7. Number of Substrings Containing All Three Characters (Leetcode-1358)
	8. Longest Continuous Subarray With Absolute Diff Less Than or Equal to Limit (Leetcode-1438)
	9. Longest K unique characters substring (GFG)
	10. Maximum Number of Occurrences of a Substring (Leetcode-1297)
	11. Maximum Points You Can Obtain from Cards (Leetcode-1423)
	12. Find All Anagrams in a String (Leetcode-438)
	13. K Radius Subarray Averages (Leetcode-2090)
	14. Number of Sub-arrays of Size K and Average Greater than or Equal to Threshold (Leetcode-1343)
	15. Minimum Consecutive Cards to Pick Up (Leetcode-2260)
	16. Maximum Erasure Value (Leetcode-1695)
	17. Arithmetic Slices (Leetcode-413)
	18. Maximum Number of Vowels in a Substring of Given Length (Leetcode-1456)
	19.  Substring with Concatenation of All Words (Leetcode-30)
	20. Substrings of Size Three with Distinct Characters (Leetcode-1876)
...
CLASS NOTES: 67
	...
	Summary Resource : https://leetcode.com/discuss/interview-question/3695233/all-types-of-patterns-for-bits-manipulations-and-how-to-use-it
	Resource 1: Dynamic programming on subsets with examples, explained : https://leetcode.com/discuss/general-discussion/1125779/Dynamic-programming-on-subsets-with-examples-explained
